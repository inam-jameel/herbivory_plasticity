######## PROJECT: Water availability and herbivory interact to shape the adaptive landscape 
#### PURPOSE:Examine fitness, traits, selection in response to water availability and herbivory .
#### AUTHORS: Inam Jameel & Jill Anderson
#### DATE LAST MODIFIED: 30 march 24
...
VWC_data$yearcensus <- interaction(VWC_data$Year, VWC_data$census)



VWC_mod <- glmmTMB(VWC ~Water*Year*Herbivore+(1|yearcensus) + (1|Cage_Block), data= VWC_data,family=Gamma(link="log"))
