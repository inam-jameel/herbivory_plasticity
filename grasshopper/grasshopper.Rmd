...
setwd("~/Desktop/Anderson_data/herbivory/data/field/grasshopper/")
...
#removing the individuals that had too young leaves for SLA
grasshopper <- filter(grasshopper, Exclude_2022_SLA == "Include")
