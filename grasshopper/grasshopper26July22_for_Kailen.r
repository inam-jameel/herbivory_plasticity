...
hurdle_Model = glmmTMB (Mature_silique_number_2022 ~ S_initdiam +elev_km* Herbivore* Treatment + (1|block)+ (1| population), zi=~ S_initdiam +elev_km* Herbivore* Treatment  + (1|block)+ (1| population),data = filter(grasshopper, Reproduction_2022 == 1) ,family=truncated_nbinom2)
