...
##Data
GH<-read.csv("season1_2genGH_masterfile.csv", header=T)
sapply(GH,class)
...
Empty <-read.csv("season1_2genGH_empty.csv", header=T)
...
Empty$Mature_length_siliques[target_row]<-sum(sub[,c(42,44,46,48,50,52,54,56,58,60,62,64,66,68,70,72,74,76,78,80,82,84)], na.rm=T)
...
write.xlsx(Empty, "Season1_GHSummary2021.xlsx", sheetName="Summary2021", colnames=TRUE, rownames=TRUE, keepNA=TRUE) 
