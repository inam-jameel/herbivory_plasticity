setwd("/Users/inam/Library/CloudStorage/OneDrive-UniversityofGeorgia/Inam_experiments/Herbivory_data/field/2021_files/census_files")
...
##Data
gothic<-read.csv("inam_gothic2020_census21.csv", header=T)
sapply(gothic,class)
...
Empty_input<-read.csv("inam_gothic2020_empty21.csv", header=T)
...
ifelse((sub$Status[21]=="Alive"), Empty$Season_survival_2021[target_row]<-1, Empty$Season_survival_2021[target_row]<-0)
...
Empty$Exclude_2021[target_row]<-sub$Include[21] 
...
#Empty$num_total3_2021[target_row]<-sub$Leaf_number[3] 
#Empty$num_damaged3_2021[target_row]<-sub$Damaged_leaves[3] 
#Empty$total_damage3_2021[target_row]<-sub$total_damage[3]
#Empty$avg_damage3_2021[target_row]<-sub$average_damage[3]
#Empty$LAR_3_2021[target_row]<-sub$LAR[3] 

#Empty$num_total7_2021[target_row]<-sub$Leaf_number[7] 
#Empty$num_damaged7_2021[target_row]<-sub$Damaged_leaves[7] 
#Empty$total_damage7_2021[target_row]<-sub$total_damage[7]
#Empty$avg_damage7_2021[target_row]<-sub$average_damage[7]
#Empty$LAR_7_2021[target_row]<-sub$LAR[7] 


## Master notes
Empty$Master_notes_2021[target_row]<-sub$Master_notes[2] 
...
if(nrow(Repro)>=1) {
  Empty$Height2_flowering_2021[target_row]<-Repro$Height2[1] }

if(nrow(Repro)>=1) {
  Empty$Height3_flowering_2021[target_row]<-Repro$Height3[1] }
...
if(sum(Repro$Flower_number, na.rm=T)>=1) { #closes below
  ...
  Empty$Height2_peak_2021[target_row]<-Repro$Height2[which(Repro$Flower_number==max_fl)][1]
  
  Empty$Height3_peak_2021[target_row]<-Repro$Height3[which(Repro$Flower_number==max_fl)][1]
...
if(sum(Repro$Silique_number, na.rm=T)>=1) { #outer if statement
  ...
  Empty$Height2_silique_2021[target_row]<-Repro$Height2[1]
  
  Empty$Height3_silique_2021[target_row]<-Repro$Height3[1]
...
Empty$Mature_length_siliques_2021[target_row]<-sum(sub[,c(32,
                                                          34,
                                                          36,
                                                          38,
                                                          40,
...
write.xlsx(Empty, "gothic2020_2021_summary.xlsx", sheetName="Summary2021", colnames=TRUE, rownames=TRUE, keepNA=TRUE) 
...
##Data
gothic<-read.csv("inam_gothic2021_census21_test.csv", header=T)
sapply(gothic,class)
...
Empty_input<-read.csv("inam_gothic2021_empty21.csv", header=T)
Empty <- Empty_input[order(Empty_input$PlantID),]
row.names(Empty) <- 1:nrow(Empty)
...
for (i in 1:length(unique(gothic$PlantID))){ 
  ...
  #season_survival - Census 11 was the last full census, alive=1 dead=0
  ifelse((sub$Status[19]=="Alive"), Empty$Season_survival_2021[target_row]<-1, Empty$Season_survival_2021[target_row]<-0)
  
  #season_Include - Census 10 was the last full census, alive=1 dead=0
  #ifelse((sub$Include[10]=="Alive"), Empty$Season_survival_2021[target_row]<-1, Empty$Season_survival_2021[target_row]<-0)
  Empty$Exclude_2021[target_row]<-sub$Include[19] 
  ...
  #Mature_length_siliques - note that the column numbers have to be updated
  Empty$Mature_length_siliques_2021[target_row]<-sum(sub[,c(54,
                                                            56,
                                                            58,
                                                            60,
                                                            62,
...
##Data
scho<-read.csv("inam_schofield2020_census21.csv", header=T)
sapply(scho,class)
...
Empty_input<-read.csv("inam_schofield2020_empty21.csv", header=T)
Empty <- Empty_input[order(Empty_input$PlantID),]
row.names(Empty) <- 1:nrow(Empty)
...
for (i in 1:length(unique(scho$PlantID))){ 
  ...
  #season_survival - Census 11 was the last full census, alive=1 dead=0
  ifelse((sub$Status[12]=="Alive"), Empty$Season_survival_2021[target_row]<-1, Empty$Season_survival_2021[target_row]<-0)
  
  #season_Include - Census 10 was the last full census, alive=1 dead=0
  #ifelse((sub$Include[10]=="Alive"), Empty$Season_survival_2021[target_row]<-1, Empty$Season_survival_2021[target_row]<-0)
  Empty$Exclude_2021[target_row]<-sub$Include[12] 
  ...
  # leaf damage was assessed on  censuses 2,3,5
  
  Empty$LAR_1_2021[target_row]<-sub$LAR[2] 
  Empty$LAR_2_2021[target_row]<-sub$LAR[3] 
  Empty$LAR_3_2021[target_row]<-sub$LAR[5] 
  ...
  #Mature_length_siliques - note that the column numbers have to be updated
  Empty$Mature_length_siliques_2021[target_row]<-sum(sub[,c(34,
                                                            36,
                                                            38)], na.rm=T)
...
write.xlsx(Empty, "schofield2020_2021_summary.xlsx", sheetName="Summary2021", colnames=TRUE, rownames=TRUE, keepNA=TRUE) 


####### Estess 2021 cohort  #####

setwd("/Users/inam/Library/CloudStorage/OneDrive-UniversityofGeorgia/Inam_experiments/Herbivory_data/field/census_files")
##Data
...
Empty_input<-read.csv("inam_Estess2021_09Jul24_empty.csv", header=T)
Empty <- Empty_input[order(Empty_input$PlantID),]
row.names(Empty) <- 1:nrow(Empty)
...
check2 <-subset(Empty, PlantID=="E12363")
