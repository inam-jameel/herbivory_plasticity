...
##Data
GH<-read.delim("2genGH_010322.txt", header=T)
sapply(GH,class)
...
##Identify the row number in Empty that corresponds to this ID number 
	target_row<-as.numeric(rownames(Empty[which(Empty$exp_ID==exp_ID),]))
	
	
#Season_survival - Census 14 was the last full census, alive=1 dead=0
...
##I measured leaf damage at censuses 1,3,5,13	
